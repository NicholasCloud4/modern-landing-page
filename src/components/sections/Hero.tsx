            ...
            <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
                ...
                >
                    ...
                    <Paragraph className="mt-8">
                        Launch Base empowers your business with an AI-driven
                        SaaS platform that integrates effortlessly into your
                        existing workflows. Unlock real-time insights, automate
                        intelligently, and make smarter, data-backed
                        decisions—so you can move faster, work smarter, and
                ...
                <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-non lg:mx-0 mx-auto max-w-3xl">
                    <img
                        src="https://images.pexels.com/photos/8721320/pexels-photo-8721320.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                        alt="Hero image"
                        width={2350}
                        height={2359}
